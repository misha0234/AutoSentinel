...
def slide_window(img, x_start_stop=[None, None], y_start_stop=[None, None],
    ...
    #for ys in range(ny_windows):
    while True:
        #nx_pix_per_step = np.int(width_new  * (1 - xy_overlap[0]))
        #ny_pix_per_step = np.int(height_new * (1 - xy_overlap[1]))
        ...
        width_new  += nx_pix_per_step * (xy_overlap[0])
        height_new += ny_pix_per_step * (xy_overlap[1])
        scale += 1
